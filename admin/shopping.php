...
<body class="d-flex flex-column">
    ...
    <?php
    $activeTable = 'shopping';
    include 'buttons.php';
    ?>
    <div class="search-sec  mt-5">
        <form class="d-flex align-items-center justify-content-center" action="shopping.php" method="post">
        ...
        <table class="table w-75">
            ...
            <tbody>
                ...
                if(isset($_POST['submit'])){
                    $getID = $_POST['user_id'];
                    $get_items = "SELECT * from shopping_items where user_id='$getID'";
                    ...
                    $get_items = "SELECT * from shopping_items ";
                    $result = mysqli_query($con, $get_items);
                    while ($row = mysqli_fetch_assoc($result)) {
                        $shop_id = $row['shop_id'];
                        $user_id = $row['user_id'];

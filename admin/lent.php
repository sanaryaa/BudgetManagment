...
<body class="d-flex flex-column">
    ...
    <div class="search-sec  mt-5">
        <form class="d-flex align-items-center justify-content-center" action="lent.php" method="post">
        ...
        <table class="table w-75">
            ...
            <tbody>
                ...
                if(isset($_POST['submit'])){
                    $getID = $_POST['user_id'];
                    $get_items = "SELECT * from lent_items where user_id='$getID'";
                    ...
                    $get_items = "SELECT * from lent_items ";
                    $result = mysqli_query($con, $get_items);
                    while ($row = mysqli_fetch_assoc($result)) {
                        $lent_id = $row['lent_id'];
                        $user_id = $row['user_id'];

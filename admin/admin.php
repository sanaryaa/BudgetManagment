...
session_start();
//unset user to dont let admin go to the users pages
unset($_SESSION['user']);
    ...
    <div class="search-sec  mt-5">
        <form class="d-flex align-items-center justify-content-center" action="admin.php" method="post">
            <div class="form-group d-flex  align-items-center justify-content-center ">
                ...
                <input type="text" class="form-control searchText" id="exampleInputSearch" aria-describedby="emailHelp" name="user_id">
            </div>
            <input type="submit" name="submit" class="btn btn-primary searchSubmit" value="Search">
        </form>
    </div>
        ...
        <table class="table w-75 ">
            ...
            <tbody>
                ...
                if (isset($_POST['submit'])) {
                    $getID = $_POST['user_id'];
                    $get_items = "SELECT * from food_items where user_id='$getID'";

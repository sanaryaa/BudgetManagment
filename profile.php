            ...
            <div class="modal-content">
                ...
                <div class="modal-body px-5">
                    ...
                    <form id="myForm" class="needs-validation" novalidate action="update.php" method="post">
                        <div class="mb-3">
                            <label for="input1" class="form-label fs-5">Full Name</label>
                            <input type="hidden" name="user_id" value="<?php echo $_SESSION['user_id']; ?>" />
                            <div class="form-row d-flex">
                                <div class="col ">
                                    <input type="text" name="first_name" class="form-control" value="<?php echo $_SESSION['first_name']; ?>" placeholder="First name" required>
                                    <div class="invalid-feedback">
                                        Please fill your firstname
                                    </div>
                                </div>
                                <div class="col">
                                    <input type="text" name="last_name" class="form-control" value="<?php echo $_SESSION['last_name']; ?>" placeholder="Last name" required>
                                    <div class="invalid-feedback">
                            ...
                            <input type="text" class="form-control" id="input1" name="username" value="<?php echo $_SESSION["username"]; ?>" placeholder="username" required>
                            <div class="invalid-feedback">
